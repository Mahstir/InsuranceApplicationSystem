...
{
    public class MyBookingsController : ApiController
    {
        ...
        public Booking MyBookings()
        {
            ...
            var myBookings = _context.Bookings.Include(c => c.InsurancePackage).Include(c => c.Member).SingleOrDefault(c => c.ApplicationUserId == currentUser);
